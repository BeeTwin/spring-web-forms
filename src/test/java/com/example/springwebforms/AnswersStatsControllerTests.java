...
public class AnswersStatsControllerTests {
    ...
    public void controllerShowsCorrectData() throws Exception {
        this.mockMvc.perform(get("/answer/stats/1"))
                .andDo(print())
                .andExpect(content().string(containsString("Ответы на форму Тестовая форма от test_admin")));
    }
}
